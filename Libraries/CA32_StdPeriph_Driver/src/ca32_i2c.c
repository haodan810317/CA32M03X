/**
  ...
  *           + SMBUS management I2C1 supported, I2C2 not supported
...
/**
  * @brief  Enables or disables the Address stretching in I2C Clock stretching mode.
  * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral.
  * @param  NewState: new state of the I2Cx Address stretching.
  *          This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void I2C_AddressStretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    /* Enable Address stretching */
    I2Cx->CR1 &= (uint32_t)~((uint32_t)I2C_CR1_ADDRNOSTRETCH);
  }
  else
  {
    /* Disable Address stretching  */
    I2Cx->CR1 |= I2C_CR1_ADDRNOSTRETCH;
  }
}

/**
  * @brief  Enables or disables the I2C own address 1.
  * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral.
  * @param  NewState: new state of the I2C own address 1.
  *          This parameter can be: ENABLE or DISABLE.  
  * @retval None
  */
void I2C_OwnAddress1Cmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  else
  {
    ...
    I2Cx->OAR1 &= (uint32_t)~((uint32_t)I2C_OAR1_OA1EN);
  }
} 
...
/**
  ...
  *         This parameter can be any combination of @ref I2C_own_address2_mask
  * @retval None
  */
