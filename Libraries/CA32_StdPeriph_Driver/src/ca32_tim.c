/**
 ...
 ===============================================================================
    [..] This driver provides functions to configure and program the TIM 
         of all CA32 devices These functions are split in 8 groups: 
         ...
         (#) TIM interrupts, flags management.
...
/**
  ...
  * @param  TIMx: where x can be 0, 1, 2, 3, 4, 5 to select the TIM peripheral.
  * @retval None
  *   
  */
...
/**
  ...
  * @param  TIMx: where x can be 0, 1, 2, 3, 4, 5 to select the TIM peripheral.
4  * @param  TIM_OCInitStruct: pointer to a TIM_OCInitTypeDef structure
...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
 ...
 /* Disable the Channel 1: Reset the CC1E Bit */
  ...
  /* Reset the complementary Output Polarity level */
...
void TIM_OC4Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OutputState << 12);
	...
	/* Reset the complementary Output Polarity level */
  tmpccer &= (uint16_t)(~((uint16_t)TIM_CCER_CC4NP));
  /* Set the complementary Output Compare Polarity */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OCNPolarity << 12);
  
  /* Set the complementary Output State */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OutputNState << 12);   
...
void TIM_OC5Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));   
  /* Disable the Channel 2: Reset the CC2E Bit */
  TIMx->CCER &= (uint16_t)(~((uint16_t)TIM_CCER_CC5E));
...
void TIM_OC6Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  assert_param(IS_TIM_OUTPUT_STATE(TIM_OCInitStruct->TIM_OutputState));
  assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));   
  /* Disable the Channel 2: Reset the CC6E Bit */
  TIMx->CCER &= (uint16_t)(~((uint16_t)TIM_CCER_CC6E));
  ...
  /* Reset the Output Compare mode and Capture/Compare selection Bits */
  tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR3_OC6M));
  
  /* Select the Output Compare Mode */
  tmpccmrx |= (uint16_t)(TIM_OCInitStruct->TIM_OCMode << 8);
  
  /* Reset the Output Polarity level */
  tmpccer &= (uint16_t)(~((uint16_t)TIM_CCER_CC6P));
  /* Set the Output Compare Polarity */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OCPolarity << 12);
...
/** @defgroup TIM_Group5 Interrupts flags management functions
 *  @brief    Interrupts, flags management functions 
 *
@verbatim
 ===============================================================================
...
/**
  ...
  *          This parameter can be one of the following values:
  *
  *         TIM_TRGO2Source_Reset 
  *         TIM_TRGO2Source_Enable
  *         TIM_TRGO2Source_Update
  *         TIM_TRGO2Source_OC1   
  *         TIM_TRGO2Source_OC1Ref
  *         TIM_TRGO2Source_OC2Ref
  *         TIM_TRGO2Source_OC3Ref
  *         TIM_TRGO2Source_OC4Ref
  *         TIM_TRGO2Source_OC5Ref
  *         TIM_TRGO2Source_OC6Ref
  *         TIM_TRGO2Source_OC4RisingFaling   
  *         TIM_TRGO2Source_OC6RisingFaling   
  *         TIM_TRGO2Source_OC4RisingOC6Rising
  *         TIM_TRGO2Source_OC4RisingOC6Faling
  *         TIM_TRGO2Source_OC4andOC5Rising   
  *         TIM_TRGO2Source_OC5RisingOC6Faling
  *
  * @retval None
  */
void TIM_SelectOutputTrigger2(TIM_TypeDef* TIMx, uint32_t TIM_TRGO2Source)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST9_PERIPH(TIMx));
  assert_param(IS_TIM_TRGO2_SOURCE(TIM_TRGOSource));

  /* Reset the MMS Bits */
  TIMx->CR2 &= (uint32_t)~((uint16_t)TIM_CR2_MMS2);
  /* Select the TRGO source */
