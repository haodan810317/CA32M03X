/**
  ...
  *
  *  @verbatim
    [..] The I2S feature is not implemented in CA32 Ultra Low Power
         Medium-density devices and it's supported only CA32 Ultra Low Power
...
/**
  ...
  * @note   SPI2 is not available for CA32M030 devices.
  *         I2S mode is not supported for CA32M030 devices.      
  * @retval None
  */
...
/**
  ...
  *    
  * @param  SPIx: where x can be 1 or 2 to select the SPI peripheral.
  * @note   SPI2 is not available for TH32F031 devices.
...
@verbatim
 ...
 ===============================================================================
    ...
    -@-
       ...
       SPI bandwidth.
       (+@) When the CA32 are configured as slaves and the NSS hardware mode is 
