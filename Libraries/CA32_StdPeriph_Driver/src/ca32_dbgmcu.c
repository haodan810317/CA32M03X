...
/**
  ...
  *             @arg DBGMCU_TIM0_STOP: TIM0 counter stopped when Core is halted
  *             @arg DBGMCU_TIM6_STOP: TIM6 counter stopped when Core is halted
  *             @arg DBGMCU_TIM7_STOP: TIM7 counter stopped when Core is halted, 
  *                  applicable only for F072 devices               
  ...
  *                  applicable only for F042 and F072 devices               
