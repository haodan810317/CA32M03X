...
#define IS_TIM_ALL_PERIPH(PERIPH) (((PERIPH) == TIM20) || \
                                   ((PERIPH) == TIM2) || \
                                   ((PERIPH) == TIM3) || \
                                   ((PERIPH) == TIM6) || \
                                   ((PERIPH) == TIM7))
...
/* LIST1: TIM 1 */
#define IS_TIM_LIST1_PERIPH(PERIPH)  ((PERIPH) == TIM20)
...
/* LIST3: TIM 6 , 7 */
#define IS_TIM_LIST3_PERIPH(PERIPH) (((PERIPH) == TIM6) || \
                                     ((PERIPH) == TIM7)) 
...
#define IS_TIM_IT(IT) ((((IT) & (uint16_t)0x5F00) == 0x0000) && ((IT) != 0x0000))
...
#define IS_TIM_EVENT_SOURCE(SOURCE) ((((SOURCE) & (uint16_t)0x5F00) == 0x0000) && ((SOURCE) != 0x0000))
...
/** @defgroup TIM_Trigger2_Output_Source 
  * @{
  */
...
#define TIM_TRGO2Source_OC4RisingFaling     ((uint32_t)0x00A00000)
#define TIM_TRGO2Source_OC6RisingFaling     ((uint32_t)0x00B00000)
#define TIM_TRGO2Source_OC4RisingOC6Rising  ((uint32_t)0x00C00000)
#define TIM_TRGO2Source_OC4RisingOC6Faling  ((uint32_t)0x00D00000)
#define TIM_TRGO2Source_OC4andOC5Rising     ((uint32_t)0x00E00000)
#define TIM_TRGO2Source_OC5RisingOC6Faling  ((uint32_t)0x00F00000)
#define IS_TIM_TRGO2_SOURCE(SOURCE) (((SOURCE) == TIM_TRGO2Source_Reset) || \
                                    ...
                                    ((SOURCE) == TIM_TRGO2Source_OC4RisingFaling) || \
                                    ((SOURCE) == TIM_TRGO2Source_OC6RisingFaling) || \
                                    ((SOURCE) == TIM_TRGO2Source_OC4RisingOC6Rising) || \
                                    ((SOURCE) == TIM_TRGO2Source_OC4RisingOC6Faling) || \
                                    ((SOURCE) == TIM_TRGO2Source_OC4andOC5Rising) || \
                                    ((SOURCE) == TIM_TRGO2Source_OC5RisingOC6Faling))
/**
  * @}
  */ 
...
#define IS_TIM_CLEAR_FLAG(TIM_FLAG) ((((TIM_FLAG) & (uint16_t)0x1E5F) == 0x0000) && ((TIM_FLAG) != 0x0000))
/**
  * @}
  */ 
...
/* Advanced-control timers (TIM20) specific features*******************/
...
void TIM_CCUpdateSelection(TIM_TypeDef* TIMx, FunctionalState NewState);
...
//void TIM_SelectOCREFClear(TIM_TypeDef* TIMx, uint16_t TIM_OCReferenceClear);  // delete by haodan for TH32F031, because TH32F031 don't support remap OCREF_CLR function
