...
#define ADC_ExternalTrigInjecEventEdge_RisingEdge	 ((uint16_t)0x0080)    /*!<  ADC external trigger rising edge for injected conversion */
#define ADC_ExternalTrigInjecEventEdge_FallingEdge	 ((uint16_t)0x0100)  /*!<  ADC external trigger falling edge for injected conversion */
#define ADC_ExternalTrigInjecEventEdge_BothEdge	     ((uint16_t)0x0180)  /*!<  ADC external trigger both edges for injected conversion */
...
/** @defgroup ADC_external_trigger_sources_for_regular_channels_conversion 
  * @{
  */
#define ADC_ExternalTrigConvEvent_TIM20_TRGO      (0)
#define ADC_ExternalTrigConvEvent_TIM20_CH1			  (ADC_CFGR_EXTSEL_0)
#define ADC_ExternalTrigConvEvent_TIM20_CH2       (ADC_CFGR1_EXTSEL_1)
#define ADC_ExternalTrigConvEvent_TIM20_CH4       (ADC_CFGR1_EXTSEL_0 | ADC_CFGR1_EXTSEL_1)
#define ADC_ExternalTrigConvEvent_ADC_CONVSTART   (ADC_CFGR1_EXTSEL_2)
#define ADC_ExternalTrigConvEvent_TIM2_TRGO       (ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_0)
#define ADC_ExternalTrigConvEvent_TIM3_TRGO       (ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_1)
#define ADC_ExternalTrigConvEvent_TIM20_TRGO2     (ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_1 | ADC_CFGR1_EXTSEL_0)

#define IS_ADC_EXT_TRIG(REGTRIG) (((REGTRIG) == ADC_ExternalTrigConvEvent_TIM20_TRGO) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_TIM20_CH1) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_TIM20_CH2) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_TIM20_CH4) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_ADC_CONVSTART) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_TIM2_TRGO) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_TIM3_TRGO) || \
                                  ((REGTRIG) == ADC_ExternalTrigConvEvent_TIM20_TRGO2))
...
#define ADC_ExternalTrigInjecConvEvent_TIM20_TRGO      (0)
#define ADC_ExternalTrigInjecConvEvent_TIM20_CH1			  (ADC_CFGR_JEXTSEL_0)
#define ADC_ExternalTrigInjecConvEvent_TIM20_CH2       (ADC_JSQR_JEXTSEL_1)
#define ADC_ExternalTrigInjecConvEvent_TIM20_CH4       (ADC_JSQR_JEXTSEL_0 | ADC_JSQR_JEXTSEL_1)
#define ADC_ExternalTrigInjecConvEvent_ADC_CONVSTART   (ADC_JSQR_JEXTSEL_2)
#define ADC_ExternalTrigInjecConvEvent_TIM2_TRGO       (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0)
#define ADC_ExternalTrigInjecConvEvent_TIM3_TRGO       (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1)
#define ADC_ExternalTrigInjecConvEvent_TIM20_TRGO2     (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0)

#define IS_ADC_EXT_INJEC_TRIG(INJTRIG) (((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM20_TRGO) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM20_CH1) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM20_CH2) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM20_CH4) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_ADC_CONVSTART) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM2_TRGO) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM3_TRGO) || \
                                        ((INJTRIG) == ADC_ExternalTrigInjecConvEvent_TIM20_TRGO2))
/**
  * @}
  */
...
/** @defgroup ADC_channels 
  * @{
  */
#define ADC_Channel_0                               ((uint8_t)0x00)    /*!<  ADC Channel 1 */
...
#define ADC_SampleTime_2Cycles5                    ((uint8_t)0x00)   /*!<  ADC sampling time 2.5 cycle */
#define ADC_SampleTime_6Cycles5                    ((uint8_t)0x01)   /*!<  ADC sampling time 6.5 cycles */
#define ADC_SampleTime_12Cycles5                   ((uint8_t)0x02)   /*!<  ADC sampling time 12.5 cycles */
#define ADC_SampleTime_24Cycles5                   ((uint8_t)0x03)   /*!<  ADC sampling time 24.5 cycles */
#define ADC_SampleTime_47Cycles5                   ((uint8_t)0x04)   /*!<  ADC sampling time 47.5 cycles */
#define ADC_SampleTime_92Cycles5                   ((uint8_t)0x05)   /*!<  ADC sampling time 92.5 cycles */
#define ADC_SampleTime_247Cycles5                  ((uint8_t)0x06)   /*!<  ADC sampling time 247.5 cycles */
#define ADC_SampleTime_640Cycles5                  ((uint8_t)0x07)   /*!<  ADC sampling time 640.5 cycles */
#define IS_ADC_SAMPLE_TIME(TIME) (((TIME) == ADC_SampleTime_2Cycles5) || \
                                  ((TIME) == ADC_SampleTime_6Cycles5) || \
                                  ((TIME) == ADC_SampleTime_12Cycles5) || \
                                  ((TIME) == ADC_SampleTime_24Cycles5) || \
                                  ((TIME) == ADC_SampleTime_47Cycles5) || \
                                  ((TIME) == ADC_SampleTime_92Cycles5) || \
                                  ((TIME) == ADC_SampleTime_247Cycles5) || \
                                  ((TIME) == ADC_SampleTime_640Cycles5))
/**
  * @}
  */
...
/** @defgroup ADC_injected_Channel_selection 
  * @{
  */
#define ADC_InjectedChannel_0                       ADC_Channel_0        /*!<  ADC Injected channel 0 */
...
#define IS_ADC_INJECTED_CHANNEL(CHANNEL) (((CHANNEL) == ADC_InjectedChannel_0) || \
...
uint32_t ADC_CH0GetCalibrationValue(ADC_TypeDef* ADCx);
void ADC_CH0SetCalibrationValue(ADC_TypeDef* ADCx, uint32_t ADC_Calibration);
uint32_t ADC_CH1GetCalibrationValue(ADC_TypeDef* ADCx);
void ADC_CH1SetCalibrationValue(ADC_TypeDef* ADCx, uint32_t ADC_Calibration);
...
void ADC_JDMACmd(ADC_TypeDef* ADCx, FunctionalState NewState); 
...
void ADC_SetVREFSelection(uint32_t VREFSelection);
