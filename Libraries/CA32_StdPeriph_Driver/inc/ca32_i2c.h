...
#define I2C_OA2_Mask03                  ((uint8_t)0x04)
#define I2C_OA2_Mask04                  ((uint8_t)0x08)
#define I2C_OA2_Mask05                  ((uint8_t)0x10)
#define I2C_OA2_Mask06                  ((uint8_t)0x20)
#define I2C_OA2_Mask07                  ((uint8_t)0x40)
#define I2C_OA2_MaskAll                 ((uint8_t)0x7F)

#define IS_I2C_OWN_ADDRESS2_MASK(MASK)  ((MASK) < (uint8_t)0x80)
...
#define I2C_IT_OA1I                     I2C_CR1_OA1IE
#define I2C_IT_OA2I                     I2C_CR1_OA2IE

#define IS_I2C_CONFIG_IT(IT)            ((((IT) & (uint32_t)0x3FFFFF01) == 0x00) && ((IT) != 0x00))
...
#define  I2C_FLAG_OA1                   I2C_ISR_OA1
#define  I2C_FLAG_OA2                   I2C_ISR_OA2

#define IS_I2C_CLEAR_FLAG(FLAG)         ((((FLAG) & (uint32_t)0x3FFF4000) == 0x00) && ((FLAG) != 0x00))
...
#define IS_I2C_GET_FLAG(FLAG)           (((FLAG) == I2C_FLAG_TXE) || ((FLAG) == I2C_FLAG_TXIS) || \
                                         ...
                                         ((FLAG) == I2C_FLAG_BUSY)  || ((FLAG) == I2C_FLAG_OA1) || \
																				 ((FLAG) == I2C_FLAG_OA2))
...
#define  I2C_IT_OA1                     I2C_ISR_OA1
#define  I2C_IT_OA2                     I2C_ISR_OA2

#define IS_I2C_CLEAR_IT(IT)             ((((IT) & (uint32_t)0x3FFFC001) == 0x00) && ((IT) != 0x00))
...
void I2C_AddressStretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState);
void I2C_StopModeCmd(I2C_TypeDef* I2Cx, FunctionalState NewState); /*!< not applicable for F030 devices */
void I2C_OwnAddress1Cmd(I2C_TypeDef* I2Cx, FunctionalState NewState);
