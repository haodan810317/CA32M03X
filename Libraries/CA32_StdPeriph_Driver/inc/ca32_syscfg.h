...
#ifndef __CA32_SYSCFG_H
#define __CA32_SYSCFG_H
...
#define __HAL_DBGMCU_FREEZE_IWDG()           (SYSCFG->DBGCFG |= (SYSCFG_DBGCFG_IWDG))
#define __HAL_DBGMCU_UNFREEZE_IWDG()         (SYSCFG->DBGCFG &= ~(SYSCFG_DBGCFG_IWDG))

#define __HAL_DBGMCU_FREEZE_WWDG()           (SYSCFG->DBGCFG |= (SYSCFG_DBGCFG_WWDG))
#define __HAL_DBGMCU_UNFREEZE_WWDG()         (SYSCFG->DBGCFG &= ~(SYSCFG_DBGCFG_WWDG))
